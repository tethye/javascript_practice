...
function reveal() {
  ...
  ifrm.setAttribute("src","tuhin.jpg");
  ifrm.setAttribute("alt","myLove");
  ifrm.setAttribute("width","300px");
  ifrm.setAttribute("height","400px"); 

  
  /*var ifrm = document.createElement("video");
  ifrm.setAttribute("controls","controls");
  
  var sour = document.createElement("source");
  sour.setAttribute("src", "me.mp4");
